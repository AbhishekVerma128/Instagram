...
const Home = ()=>{
    const defaultPic ="https://t3.ftcdn.net/jpg/03/46/83/96/240_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg"
   ...
   // console.log(card);
    ...
    useEffect(()=>{
        ...
        fetch("https://instagram-clone-trzg.onrender.com/allposts",{
            headers: {
    ...
    if(gif){
        return (
            <>
                <center>
                    <img src={require('../../imgs/loading.gif')} alt="load" style={{height:"20%", width:"20%", marginTop:"50px", }} />
            ...
            {allPost.map((post,index)=>{
                ...
                <div className="card-Header">
                    <div className="card-pic">
                        <img src={post.postedBy.Photo?post.postedBy.Photo:defaultPic} alt="" />
                    </div>
