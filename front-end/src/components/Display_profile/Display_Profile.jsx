...
export default function Display_Profile() {
  var ProfilePicLink = "https://cdn-icons-png.flaticon.com/512/1177/1177568.png"
    ...
    const {id} = useParams()
        ...
        const follow = (id)=>{
            fetch('https://instagram-clone-trzg.onrender.com/follow',{
                method: "put",
                headers: {
        ...
        // to unfollow user
  const unfollow = (id) => {
    fetch("https://instagram-clone-trzg.onrender.com/unfollow", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
    ...
    useEffect(()=>{
        ...
        fetch(`https://instagram-clone-trzg.onrender.com/userProfile/${id}`, {
            headers:{
                "Authorization": "Bearer " + localStorage.getItem("jwt")
            }
